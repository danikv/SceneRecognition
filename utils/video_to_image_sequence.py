...
for subdir, dirs, files in os.walk(dataset):
    for file in files:
        ...
        subprocess.call(['C:/Users/Dani/Documents/ffmpeg/bin/ffmpeg', '-i', os.path.join(dataset, file), '-r', str(args.fps), '-s', '224x224', '-vsync', 'vfr', os.path.join(output_dir_for_video, 'video-%05d.png')])
